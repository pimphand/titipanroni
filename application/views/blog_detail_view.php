...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-5" data-aos="fade-up">
              ...
              <h1 class="mb-3 text-white">KOTA MADIUN</h1>
              <p>Memiliki ragam Sejarah, Seni, Budaya yang menarik untuk dikaji. Satu Tempat, Banyak Cerita, Kota Madiunku.</p>
    ...
    <div class="site-section">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-12">
            <div class="heading-39101 mb-5">
              <span class="backdrop text-center">KOTA MADIUN</span>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-12 mb-4" data-aos="fade-up">
          <div class="listing-item">
            <div class="listing-image">
              <img src="<?php echo base_url().'assets/images/'.$image;?>" alt="Image" class="img-fluid"> 
            </div>
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="heading-39101 mb-5">
                  ...
                  <h3 style="font-family:futura bk bt"></h3>
                </div>
        ...
        <div class="site-section bg-image overlay" style="background-image: url('images/covera.jpg')">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center">
                ...
                <p class="mb-0"><a href="#" class="btn btn-primary text-white py-3 px-4">Kembali Ke Halaman Utama</a></p>
              </div>
            </div>
          </div>
        </div>
